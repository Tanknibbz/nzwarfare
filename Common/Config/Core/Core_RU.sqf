...
_c = _c + ['RU_Soldier_AT'];
_i = _i + [['','',210,5,-1,1,0,0.8,'Russians',[]]];

_c = _c + ['RU_Soldier_HAT'];
_i = _i + [['','',220,6,-1,3,0,0.84,'Russians',[]]];

_c = _c + ['RU_Soldier_AA'];
_i = _i + [['','',225,6,-1,1,0,0.81,'Russians',[]]];
...
_c = _c + ['GAZ_Vodnik'];
_i = _i + [['','',700,22,-2,1,1,0,'Russians',[]]];

_c = _c + ['GAZ_Vodnik_HMG'];
_i = _i + [['','',750,24,[false,true,2,0],2,1,0,'Russians',[[0]]]];

_c = _c + ['BTR90'];
_i = _i + [['','',1250,25,-2,3,1,0,'Russians',[]]];

_c = _c + ['GRAD_RU'];
_i = _i + [['','',1700,25,-2,3,1,0,'Russians',[]]];
...
_c = _c + ['T90'];
_i = _i + [['','',5000,40,-2,if (WF_A2_Vanilla) then {2} else {3},2,0,'Russians',[]]];

_c = _c + ['2S6M_Tunguska'];
_i = _i + [['','',4500,35,-2,3,2,0,'Russians',[]]];

/* Air Vehicles */
_c = _c + ['Mi17_medevac_RU'];
_i = _i + [['','',2800,35,-2,0,3,0,'Russians',[]]];

_c = _c + ['Mi17_rockets_RU'];
_i = _i + [['','',3000,45,-2,1,3,0,'Russians',[]]];

_c = _c + ['Mi24_V'];
_i = _i + [['','',6000,50,-2,2,3,0,'Russians',[]]];

_c = _c + ['Mi24_P'];
_i = _i + [['','',6400,52,-2,2,3,0,'Russians',[]]];

_c = _c + ['Su34'];
_i = _i + [['','',7500,55,-2,3,3,0,'Russians',[]]];

_c = _c + ['Su39'];
_i = _i + [['','',7500,55,-2,3,3,0,'Russians',[]]];

_c = _c + ['Ka52'];
_i = _i + [['','',if ((missionNamespace getVariable "WFBE_C_UNITS_BALANCING") > 0) then {8500} else {10000},55,-2,if ((missionNamespace getVariable "WFBE_C_UNITS_BALANCING") > 0) then {2} else {3},3,0,'Russians',[]]];
