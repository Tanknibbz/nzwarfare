...
//--- Flag texture.
missionNamespace setVariable [Format["WFBE_%1FLAG", _side], 'flag_nz_co.paa'];
...
if (local player) then {
	...
	(_side) Call Compile preprocessFileLineNumbers "Common\Config\Loadout\Loadout_ANZAC.sqf";
};	
...
missionNamespace setVariable [Format["WFBE_%1_DefaultGear", _side], [
	...
	//--- Squads.
	(_side) Call Compile preprocessFileLineNumbers "Common\Config\Core_Squads\Squad_ANZAC.sqf";
	//--- Artillery.
	(_side) Call Compile preprocessFileLineNumbers "Common\Config\Core_Artillery\Artillery_OA_US.sqf";
	//--- Units.
	(_side) Call Compile preprocessFileLineNumbers "Common\Config\Core_Units\Units_ANZAC.sqf";
	//--- Structures.
