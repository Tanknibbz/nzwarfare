...
//--- Overall Dump.
_return = ["West", "ANZAC"] Call Compile preprocessFile "Common\Config\Core_Squads\Squads_GetFactionGroups.sqf";
...
_aiTeamTemplateName = _aiTeamTemplateName + ["Armor - Scorpion Section"];
...
_aiTeamTemplateName = _aiTeamTemplateName + ["Air - UH1H Squadron"];
_aiTeamTemplates = _aiTeamTemplates + [_u];
